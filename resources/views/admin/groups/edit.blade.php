            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal " action="{{ route('groups.update', $userGroup->id) }}"
                            method="POST">
                            @method('put')
                            @csrf
                            <div class="form-group has-warning">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" value="{{$userGroup->name}}" name="name" placeholder=""
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-6">
                                    ...
                                    <a href="{{ route('groups.index') }}" class="w3-button w3-red"
                                        type="submit">Hủy</a>
                                </div>
                            </div>
                        </form>
