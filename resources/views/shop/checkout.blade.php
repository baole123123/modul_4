    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <form class="checkout-form" method="POST" action="{{ route('add') }}">
                    @csrf
                    ...
                    <div class="bg-light p-30">
                        <div class="row">
                            ...
                            <a href="{{ route('shop.login', ['redirect' => route('checkOuts')]) }}" class="btn btn-danger">Đăng Nhập</a>
                            @endif
                            @php
                                    ...
                                    <div class="border-bottom">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <p> <input type="hidden" value="{{ $id }}" name="product_id[]">{{ $details['name'] ?? '' }}
                                                </p>
                                                </td>
